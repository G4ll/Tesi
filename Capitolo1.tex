...
\begin{proof}
	...
	\end{tikzcd} \]
	Applicando ripetutamente l'iniettività dei moduli riusciamo a estendere la mappa a tutta la risoluzione \todo[la sto facendo più facile del dovuto?]
	\[\begin{tikzcd}[column sep = small]
	0 \rar
...
Per estendere la mappa a tutti i gradi partiamo da una risoluzione iniettiva di $ A $, prendiamone gli invarianti sia rispetto ad $ H $ che a $ G $ e, prima di prenderene l'omologia, applichiamo la norma per ottenere un morfismo di complessi \todo[perché è un morismo di complessi?]
\[\begin{tikzcd}
0 \rar
