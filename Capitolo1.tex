...
%	Poiché un sottogruppo chiuso e d'indice finito è anche aperto, possiamo applicare il corollario \ref{ntors}, per passare al limite (come nella proposizione \ref{limite}) e scoprire che i gruppi di coomologia dei gruppi profiniti sono anch'essi di torsione.
\end{profinite}
...
%%	&& \Hh^{-1}(G, \, A) \dar \rar[dashed]
%%	& \Hh^{-1}(G, \, B) \dar \rar[dashed]
%%	& \Hh^{-1}(G, \, C) \dar \arrow[dddll, out=0, in=0, dashed, rounded corners = 10pt,
%%	to path={ --([xshift=3ex]\tikztostart.east)
%%		|- (C)[near end]\tikztonodes
...
%%	\dots \rar
%%	& \Hh^{-2}(G, \, C) \rar["\delta_0"] \arrow[ur, dashed, bend left = 30]
%%	& A_G \rar \dar[""{coordinate, name=A}] 
%%	& B_G \rar \dar[""{coordinate, name=B}]
%%	& C_G \rar \dar[""{coordinate, name=C}]
%%	& 0 & \\
%%	& 0 \rar
%%	&A^G \rar\dar
%%	& B^G \rar\dar
...
\begin{proof}
	...
	& \Hhh^{-1}(G, \, C) \dar \ar[out=0, in=180, looseness=1, dashed]{dddll} %\arrow[dddll, dashed]
	&& \\
	\dots \rar
