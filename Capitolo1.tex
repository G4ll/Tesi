...
I gruppi coomologia sono funtoriali nei coefficienti $ A $ per costruzione. Siamo interessati a capire che tipo di relazioni otteniamo al variare del gruppo $ G $ che agisce. Un problema, puramente formale, che si pone immediatamente è che cambiando gruppo abbiamo bisogno di cambiare la categoria ambiente: definiamo quindi il funtore di transizione, in un qualche senso imparentato al funtore dimenticante.
